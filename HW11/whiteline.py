...
# plt.plot(index,reds,'r-', index,greens,'g-', index,blues,'b-',index,sum,'k-',index,sum_smooth,'p-',index, diff_sum,'y-*')
plt.plot(index,reds,'r-', index,greens,'g-', index,blues,'b-',index,sum,'k-',index,vals,'y-')
plt.show()